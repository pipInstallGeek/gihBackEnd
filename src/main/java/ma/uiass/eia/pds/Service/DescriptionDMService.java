...
public class DescriptionDMService implements IDescriptionDMService{
    ...
    @Override
    public void ajouter(DescriptionDM dispositifMedical) {descriptionDao.add(dispositifMedical);}
   @Override
   ...
   public  int trouverQuantitéByDM(String nomDM){
    ...
    public void supprimerDM(String nomDM) {
        DescriptionDM dispositifMedical = descriptionDao.findbyNom(nomDM);
