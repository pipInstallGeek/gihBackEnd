            ...
            public class App extends ResourceConfig {
               ...
               Admission reser1=new Admission("reser1", "2020-05-06", null,lit13);
                ...
                DescriptionDM des1=new DescriptionDM("fourniture",15,chambre);
                DescriptionDM des2=new DescriptionDM("instruments léger",15,chambre);
                ...
                descriptionDMService.ajouter(des2);
                  ...
                  TypeDM typeDM1=new TypeDM(des1,"bandes");
                TypeDM typeDM2=new TypeDM(des1,"pansements");
                TypeDM typeDM3=new TypeDM(des2,"pinces");
                TypeDM typeDM4=new TypeDM(des2,"ciseaux");
                typeDMService.ajouter(typeDM1);
                typeDMService.ajouter(typeDM2);
                typeDMService.ajouter(typeDM3);
                typeDMService.ajouter(typeDM4);
