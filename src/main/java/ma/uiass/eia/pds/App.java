...
//
//
//                Ambulance ambulance=new Ambulance("2023-05-20",LocalDate.now().toString(),0);
//                Ambulance ambulance1=new Ambulance("2023-06-20",LocalDate.now().toString(),0);
//                Ambulance ambulance3=new Ambulance("2023-08-20",LocalDate.now().toString(),0);
//                Ambulance ambulance2=new Ambulance("2023-07-20",LocalDate.now().toString(),0);
//                Ambulance ambulance4=new Ambulance("2023-09-20",LocalDate.now().toString(),0);
//
//                Ambulance ambulance5=new Ambulance("2023-10-20",LocalDate.now().toString(),0);
//                Ambulance ambulance6=new Ambulance("2002-05-20",LocalDate.now().toString(),0);
//                Ambulance ambulance7=new Ambulance("2001-06-20",LocalDate.now().toString(),0);
//                Ambulance ambulance8=new Ambulance("2004-08-20",LocalDate.now().toString(),0);
//                Ambulance ambulance9=new Ambulance("2005-07-20",LocalDate.now().toString(),0);
//                Ambulance ambulance10=new Ambulance("2006-09-20",LocalDate.now().toString(),0);
//
//                Ambulance ambulance11=new Ambulance("2007-10-20",LocalDate.now().toString(),0);
//                Ambulance ambulance12=new Ambulance("2008-05-20",LocalDate.now().toString(),0);
//                Ambulance ambulance13=new Ambulance("2009-06-20",LocalDate.now().toString(),0);
//                Ambulance ambulance14=new Ambulance("2010-08-20",LocalDate.now().toString(),0);
//                Ambulance ambulance15=new Ambulance("2011-07-20",LocalDate.now().toString(),0);
//                Ambulance ambulance16=new Ambulance("2012-09-20",LocalDate.now().toString(),0);
//
//                Ambulance ambulance17=new Ambulance("2015-10-20",LocalDate.now().toString(),0);
//
//
//
...
//révision.modifierDateS("REV-1","2023-05-16");
                // révision.addR("2023-06-03","AMB-1",50,"AMB-1","mv2023-07-05",TypeRévision.Révision_Maintenance_Régulière);
