            ...
            public class App extends ResourceConfig {
               ...
               /* LocalDate localDate2 = LocalDate.of(2023, 12, 13);
                ...
                Lit lit1 = new Lit(EtatLit.BONNNEETAT,true,chambre,typeLit,marque);
                Lit lit2 = new Lit(EtatLit.BONNNEETAT,true,salle,typeLit,marque);
                Lit lit3 = new Lit(EtatLit.BONNNEETAT,true,chambre1,typeLit,marque);
                Lit lit4 = new Lit(EtatLit.BONNNEETAT,false,salle1,typeLit,marque);
                Lit lit5= new Lit(EtatLit.BONNNEETAT,false,salle1,typeLit,marque);
                Lit lit6 = new Lit(EtatLit.BONNNEETAT,false,chambre2,typeLit,marque);
                Lit lit7 = new Lit(EtatLit.BONNNEETAT,false,salle2,typeLit,marque);
                Lit lit8 = new Lit(EtatLit.DEFECTUEUSE,false,chambre2,typeLit,marque);
                Lit lit9 = new Lit(EtatLit.BONNNEETAT,false,chambre2,typeLit,marque);
                Lit lit10 = new Lit(EtatLit.BONNNEETAT,false,salle2,typeLit,marque);
                Lit lit11 = new Lit(EtatLit.BONNNEETAT,false,chambre3,typeLit,marque);
                Lit lit12 = new Lit(EtatLit.BONNNEETAT,true,salle3,typeLit,marque);
                Lit lit13= new Lit(EtatLit.BONNNEETAT,false,salle2,typeLit,marque);
                Lit lit14 = new Lit(EtatLit.BONNNEETAT,false,chambre2,typeLit,marque);
                Lit lit15 = new Lit(EtatLit.BONNNEETAT,false,salle2,typeLit,marque);
                Lit lit16 = new Lit(EtatLit.DEFECTUEUSE,true,chambre2,typeLit,marque);
                Lit lit17 = new Lit(EtatLit.BONNNEETAT,false,chambre,typeLit,marque);
                Lit lit18 = new Lit(EtatLit.BONNNEETAT,false,salle,typeLit,marque);
                Lit lit19 = new Lit(EtatLit.BONNNEETAT,true,chambre3,typeLit,marque);
                Lit lit20 = new Lit(EtatLit.BONNNEETAT,true,salle3,typeLit,marque);
