...
public class Commande implements Serializable {
    ...
    public Commande(int idCommande, String numCommande, int quantite, Date dateCommande, Date dateLivraison, Boolean confirmation, List<Lit> lits) {
    ...
    public int getIdReservation() {
        ...
        public String toString() {
            return " numCommande: " + numCommande + " quantite: " + quantite + " dateCommande: " + dateCommande + " dateLivraison: " + dateLivraison + " confirmation: " + confirmation + " lits = " + lits ;}
    }
