...
public class ReapprovisionnementLit implements Serializable {
    ...
    @Column
    private String dateDemandeReap;

    @Column
    private String dateLivraisonReap;
    ...
    public ReapprovisionnementLit(Integer quantiteReap, String dateLivraisonReap, Lit lit) {
        this.quantiteReap = quantiteReap;
        this.dateDemandeReap = String.valueOf(LocalDateTime.now());
