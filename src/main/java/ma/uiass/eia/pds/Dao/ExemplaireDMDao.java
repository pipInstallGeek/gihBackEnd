...
public class ExemplaireDMDao implements IExemplaireDMDao{
    ...
    public ExemplaireDMDao(){entityManager = HibernateUtil.getEntityManger();}
    @Override
    public List<ExemplaireDM> getAll() {return entityManager.createQuery(" from ExemplaireDM ").getResultList();}
    @Override
